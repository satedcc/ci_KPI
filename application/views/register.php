                    ...
                    <div class="nk-split nk-split-page nk-split-lg">
                        <div class="nk-split-content nk-block-area nk-block-area-column nk-auth-container bg-white w-lg-45">
                            ...
                            <div class="nk-block nk-block-middle nk-auth-body">
                                ...
                                <form action="<?= base_url('register/save') ?>" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            <input required autofocus type="text" class="form-control form-control-lg" id="name" name="nama" placeholder="Enter your name">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="form-label" for="email">Email or Username</label>
                                        <div class="form-control-wrap">
                                            <input required type="text" class="form-control form-control-lg" id="email" name="username" placeholder="Enter your email address or username">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="form-note-s2 pt-4"> Already have an account ? <a href="<?= base_url('/') ?>"><strong>Sign in instead</strong></a>
                                </div>
