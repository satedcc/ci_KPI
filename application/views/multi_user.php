                                    ...
                                    <div class="row gy-4">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <div class="form-control-wrap">
                                                    <input type="text" name="email" class="form-control form-control-lg" id="email" placeholder="Input placeholder" value="<?= random_string('alpha', 10); ?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                    ...
                                    <div class="row gy-4">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <div class="form-control-wrap">
                                                    <input type="password" class="form-control form-control-lg" id="nama" placeholder="Input placeholder" value="<?= $pass ?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <div class="form-control-wrap">
                                                    <input type="password" class="form-control form-control-lg" id="email" placeholder="Input placeholder" value="<?= $pass ?>">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
